...
const CONFIG = {
  wallet: {
    ...
    subtitle: 'Verifying on-chain reserve & transaction history',
    icon: ShieldCheck,
  ...
  hub: {
    title: 'Synchronizing Titan...',
    subtitle: 'Restoring machine runtime & operational status',
    icon: Cpu,
    color: 'from-usdt-green to-emerald-600',
    shadow: 'shadow-usdt-green/30',
    text: 'text-usdt-green',
  ...
  grow: {
    ...
    subtitle: 'Fetching partner statistics & growth momentum',
    icon: Users,
  ...
  rewards: {
    ...
    subtitle: 'Auditing season milestones & achievement badges',
    icon: Gift,
  ...
  profile: {
    ...
    subtitle: 'Retrieving Titan Passport & verified certificates',
    icon: User,
